...
static const u8* main_payload_32 = 
  ...
  "  seto %al\n"
  "\n"
  " /* Check if is in the same file as the prev loc. */\n"
  "\n"
  "  cmpl  __afl_prev_file, %edx\n"
  "  je    __afl_return\n"
  "  mov %edx, __afl_prev_file\n"
  "\n"
...
static const u8* main_payload_64 = 
  ...
  "  seto  %al\n"
  "\n"
  "  cmpq  __afl_prev_file(%rip), %rdx\n"
  "  je    __afl_return\n"
  "  movq  %rdx, __afl_prev_file(%rip)\n"
  "\n"
  "  /* Check if SHM region is already mapped. */\n"
  "\n"
